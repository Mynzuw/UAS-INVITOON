...
?>
      <tr class="bg-white dark:bg-white-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-200">
        <td class="px-10 py-4 border border-b-indigo-200">
<img src="../assets/content/<?= $row["content"] ?>"style ="width:200px" ></td>
        </td>
...
<form action="../controllers/proses_hapus_konten.php" method="POST">
<input type="hidden" name="hapus_konten" value="true">
<input type="hidden" name="content" value="<?= $row["content"] ?>">
<button type="submit" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" href="../controllers/proses_hapus_konten.php?content=<?= $row["content"] ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</button>
</form> 
